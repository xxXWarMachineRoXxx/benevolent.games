...
export declare const backendForBrowser: (storage: FlexStorage) => (config: import("./types/secret-config.js").SecretConfig) => Promise<{
    rando: {
        random: () => number;
    ...
    config: import("./types/secret-config.js").SecretConfig;
    emails: {
