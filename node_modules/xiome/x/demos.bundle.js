(function () {
    ...
    async function prepareMockActions({ connection: { appId, backend: { emails, mockBrowser } }, }) {
        return {
    ...
    async function demoQuestions(connection) {
...
//# sourceMappingURL=demos.bundle.js.map
