...
export declare class ComponentWithShare<xShare> extends Component {
    readonly share: xShare;
    constructor();
}
declare const AutowatcherComponent_base: {
    new (...args: any[]): {
        auto: {
            ...
            watch: <X_1>(watcher: import("../toolbox/autowatcher/types/autowatcher-types.js").Watcher<X_1>, effect?: import("../toolbox/autowatcher/types/autowatcher-types.js").Effect<X_1>) => () => void;
            action: <xAction extends import("../toolbox/autowatcher/types/autowatcher-types.js").Action>(act: xAction) => xAction;
            actions: <xActions extends import("../toolbox/autowatcher/types/autowatcher-types.js").Actions>(object: xActions) => xActions;
            dispose: () => void;
            runInAction: (act: () => void) => void;
        };
        "__#5@#unsubscribers": (() => void)[];
        render(): void;
        subscribeAutotrack: (track: import("../toolbox/autowatcher/types/autowatcher-types.js").Track<any>) => void;
        firstUpdated(changes: Map<string | number | symbol, unknown>): void;
        dispose(): void;
...
} & ConstructorFor<LitBase>;
export declare class AutowatcherComponent extends AutowatcherComponent_base {
    init(): void;
    firstUpdated(changes: PropertyValues): void;
}
export declare class AutowatcherComponentWithShare<xShare> extends AutowatcherComponent {
    readonly share: xShare;
    constructor();
}
