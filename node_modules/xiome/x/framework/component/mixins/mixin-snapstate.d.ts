...
export declare function mixinSnapstateTracking(...tracks: Track[]): <C extends Constructor<LitBase>>(Base: C) => {
    new (...args: any[]): {
        "__#7@#tracks": Track[];
        "__#7@#unsubscribes": (() => void)[];
        render(): unknown;
        "__#7@#subscribe": (track: Track) => () => void;
        "__#7@#sub"(tracks: Track[]): void;
        "__#7@#unsub"(): void;
...
export declare function mixinSnapstateSubscriptions(...subscriptions: Subscribe[]): <C extends Constructor<LitBase>>(Base: C) => {
    new (...args: any[]): {
