...
export default {
    ...
    async "parent objects and their children are observable"() {
        ...
        const actions = auto.actions({
            ...
            setParent: (parent) => state.parent = parent,
        });
        let calledChild = 0;
        let calledParent = 0;
    ...
    async "forbids indirect circular behavior"() {
        ...
        const actions = auto.actions({
            ...
            setCountPlusOne: (value) => state.countPlusOne = value,
        });
        auto.watch(() => {
    ...
    async "effect receives observation"() {
        ...
        let lastEffect;
        auto.watch(() => state.count + 1, x => lastEffect = x);
...
//# sourceMappingURL=autowatcher.test.js.map