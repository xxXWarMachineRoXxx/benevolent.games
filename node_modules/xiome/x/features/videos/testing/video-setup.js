...
export async function videoSetup() {
    ...
    const unconstrainedAuthTables = new UnconstrainedTables(await mockAuthTables(storage));
    ...
    const videoTables = new UnconstrainedTables(await mockStorageTables(storage, {
...
//# sourceMappingURL=video-setup.js.map