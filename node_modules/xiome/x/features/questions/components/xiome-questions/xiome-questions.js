...
import { mixinStyles, mixinTicker, html, property, ComponentWithShare } from "../../../../framework/component.js";
...
let XiomeQuestions = class XiomeQuestions extends BaseComponent {
    ...
    renderQuestionsBoard() {
        ...
        const questions = sortQuestions(__classPrivateFieldGet(this, _XiomeQuestions_boardModel, "f").getQuestions(), access?.user?.userId);
