...
export async function testChatSetup() {
    ...
    async function makeServer() {
        ...
        async function makeClient(privileges, appId = defaultAppId) {
            ...
            async function clone() {
                ...
                return {
                    userId,
                    chatModel,
                    async addPrivilege(...privilegeKeys) {
                        access = {
                            ...access,
                            permit: {
                                ...access.permit,
        ...
        return {
            makeClientFor: {
                forbidden: (appId) => makeClient([], appId),
                viewer: (appId) => makeClient([chatPrivileges["view all chats"]], appId),
                participant: (appId) => makeClient([chatPrivileges["participate in all chats"]], appId),
                moderator: (appId) => makeClient([chatPrivileges["moderate all chats"]], appId),
                bannedParticipant: (appId) => makeClient([
...
//# sourceMappingURL=test-chat-setup.js.map