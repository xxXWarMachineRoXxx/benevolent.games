...
let XiomeChat = class XiomeChat extends ComponentWithShare {
    ...
    render() {
        return renderOp(__classPrivateFieldGet(this, _XiomeChat_instances, "a", _XiomeChat_model_get).state.connectionOp, () => html `
			<div class=chatbox>
            ...
            html `
						...
						${__classPrivateFieldGet(this, _XiomeChat_room, "f")?.status === ChatStatus.Online
                ? [
