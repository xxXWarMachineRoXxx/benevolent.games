        ...
        async "mock service"() {
            ...
            return {
                async "calling method returns a result"() {
                    ...
                    await expect(async () => calculator.lol()).throws();
                },
        ...
        async "mock api"() {
            ...
            return {
                ...
                async "calling a missing service throws an error"() {
                    const { api } = setup();
                    await expect(async () => api.lol()).throws();
                    await expect(async () => api.math.lol()).throws();
                },
                async "calling a missing method throws an error"() {
                    const { api } = setup();
                    await expect(async () => api.greeter.lol()).throws();
                    await expect(async () => api.math.calculator.lol()).throws();
                },
...
//# sourceMappingURL=renraku.test.js.map